...
A special case is when the model errors $\bepsilon$ are uncorrelated. Since the errors are Gaussian distributed, we know that the errors are then independent. The variance matrix $\bV$ is then a diagonal matrix
