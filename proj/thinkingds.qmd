...
### Types of Data {#sec-thinkingds-data-types}
...
the one with the highest number in the group will be shot. Or you can tell all
of them that the first criminal who tries to escape will be shot. Nobody can afford
to be first because it would mean certain death. Since noone will be first, noone
can be second and have a non-zero probability of surviving.
:::
...
![Three opaque jars.](images/ThreeJars.png){#file-three-jars fig-align="center" width=50%}
...
![Can you solve this?](images/LogicPuzzle1.png){#fig-math-puzzle1 fig-align="center" width=45%}
...
![Rectangle with numbers. What is the number in the missing cell?](images/MathPuzzleRectangle.png){#fig-rect-puzzle fig-align=center width=50%}
...
![Walking the cells in clockwise direction.](images/MathPuzzleRectangleSolution.png){#fig-rect-puzzle2 fig-align=center width=50%}
:::
