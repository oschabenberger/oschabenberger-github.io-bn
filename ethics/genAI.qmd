...
# Ethics of Generative AI {#sec-genAI}
...
![AlexNet, a convolutional neural network [@Mallick].](images/AlexNet.png){#fig-alexnet fig=align="center" width=80% .lightbox}
...
![Impact of automation through generative AI according to McKinsey](images/McKinseyAutomation.png){#fig-mckinsey fig-align="center" width=75% .lightbox}
...
:::{.quote}
This incomplete cost calculation promotes unchecked growth and a risk of unjustified 
techno-optimism with potential environmental consequences, including expanding 
demand for computing power, larger carbon footprints, shifts in patterns of 
electricity demand, and an accelerated depletion of natural resources.
:::
...
![My January 2024 biography according to ChatGPT.](images/Biography.png){#fig-bio fig-align="center" width=80% .lightbox}
...
![Images of doctors generated by Stable Diffusion.](images/StableDiffusionDoctors.png){#fig-stable-doc fig-align="center" width=80% .lightbox}

![Images of teachers generated by Stable Diffusion.](images/StableDiffusionTeachers.png){#fig-stable-teach fig-align="center" width=80% .lightbox}
